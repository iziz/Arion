...
async def track_objects(request: Request) -> JSONResponse:
    ...
    args = [
        ...
        body_or_env(body, "jerseyOcrMinConfidence", "JERSEY_OCR_MIN_CONFIDENCE", "0.6"),
        "--jersey-ocr-max-samples-per-track",
        body_or_env(body, "jerseyOcrMaxSamplesPerTrack", "JERSEY_OCR_MAX_SAMPLES_PER_TRACK", "3"),
        "--jersey-ocr-max-total-samples",
        body_or_env(body, "jerseyOcrMaxTotalSamples", "JERSEY_OCR_MAX_TOTAL_SAMPLES", "48"),
        "--jersey-ocr-min-box-height",
        body_or_env(body, "jerseyOcrMinBoxHeight", "JERSEY_OCR_MIN_BOX_HEIGHT", "0.12"),
        "--face-identity",
        body_or_env(body, "faceIdentity", "FACE_IDENTITY_ENABLED", "0"),
        "--face-identity-model",
        body_or_env(body, "faceIdentityModel", "FACE_IDENTITY_MODEL_PATH", ""),
        "--face-identity-gallery",
        body_or_env(body, "faceIdentityGallery", "FACE_IDENTITY_GALLERY_PATH", ""),
        "--face-identity-min-confidence",
        body_or_env(body, "faceIdentityMinConfidence", "FACE_IDENTITY_MIN_CONFIDENCE", "0.62"),
        "--face-identity-max-samples-per-track",
        body_or_env(body, "faceIdentityMaxSamplesPerTrack", "FACE_IDENTITY_MAX_SAMPLES_PER_TRACK", "2"),

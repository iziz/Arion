    ...
    football: {
      ...
      limitations: [
        ...
        visual?.tracking?.version === "tracking_v2"
          ? "Tracking v2 uses video-level tracker IDs, heuristic kit-color team clusters, and crop jersey OCR candidates; player identity still requires roster and match-context agreement."
